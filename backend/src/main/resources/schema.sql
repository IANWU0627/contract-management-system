...
CREATE INDEX IF NOT EXISTS idx_contract_create_time ON contract(create_time);
CREATE INDEX IF NOT EXISTS idx_contract_folder ON contract(folder_id);
...
CREATE INDEX IF NOT EXISTS idx_counterparty_contract ON contract_counterparty(contract_id);
...
CREATE INDEX IF NOT EXISTS idx_attachment_contract ON contract_attachment(contract_id);
...
CREATE INDEX IF NOT EXISTS idx_folder_parent ON contract_folder(parent_id);
CREATE INDEX IF NOT EXISTS idx_folder_creator ON contract_folder(created_by);
...
CREATE INDEX IF NOT EXISTS idx_template_category ON contract_template(category);
...
CREATE INDEX IF NOT EXISTS idx_reminder_contract ON contract_reminder(contract_id);
CREATE INDEX IF NOT EXISTS idx_reminder_expire ON contract_reminder(expire_date);
CREATE INDEX IF NOT EXISTS idx_reminder_status ON contract_reminder(status);
...
CREATE INDEX IF NOT EXISTS idx_version_contract ON contract_version(contract_id);
CREATE INDEX IF NOT EXISTS idx_version_created ON contract_version(created_at);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_contract_user ON contract_favorite(contract_id, user_id);
CREATE INDEX IF NOT EXISTS idx_favorite_user ON contract_favorite(user_id);
CREATE INDEX IF NOT EXISTS idx_favorite_contract ON contract_favorite(contract_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_tag_name ON contract_tag(name);
...
CREATE INDEX IF NOT EXISTS idx_relation_contract ON contract_tag_relation(contract_id);
CREATE INDEX IF NOT EXISTS idx_relation_tag ON contract_tag_relation(tag_id);
...
CREATE INDEX IF NOT EXISTS idx_rule_type ON reminder_rule(contract_type);
CREATE INDEX IF NOT EXISTS idx_rule_enabled ON reminder_rule(is_enabled);
...
CREATE INDEX IF NOT EXISTS idx_renewal_contract ON contract_renewal(contract_id);
CREATE INDEX IF NOT EXISTS idx_renewal_status ON contract_renewal(status);
...
CREATE INDEX IF NOT EXISTS idx_variable_category ON template_variable(category);
CREATE INDEX IF NOT EXISTS idx_variable_status ON template_variable(status);
CREATE INDEX IF NOT EXISTS idx_variable_code ON template_variable(code);
...
CREATE INDEX IF NOT EXISTS idx_contract_category_code ON contract_category(code);
CREATE INDEX IF NOT EXISTS idx_contract_category_active ON contract_category(active);
...
CREATE INDEX IF NOT EXISTS idx_quick_code_header_code ON quick_code_header(code);
...
CREATE INDEX IF NOT EXISTS idx_quick_code_item_header ON quick_code_item(header_id);
CREATE INDEX IF NOT EXISTS idx_quick_code_item_code ON quick_code_item(code);
CREATE INDEX IF NOT EXISTS idx_quick_code_item_enabled ON quick_code_item(enabled);
