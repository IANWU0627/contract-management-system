...
@TableName("contract_snapshot_diff_analysis")
public class ContractSnapshotDiffAnalysis {
    ...
    public void setBaseSnapshotId(Long baseSnapshotId) { this.baseSnapshotId = baseSnapshotId; }
    public Long getTargetSnapshotId() { return targetSnapshotId; }
    public void setTargetSnapshotId(Long targetSnapshotId) { this.targetSnapshotId = targetSnapshotId; }
